...
A full fledged Kubernetes CLI. As of now, it can parse _Pods, Namespaces, Clusters, Nodepools_ in default output, and partially most important _metadata._ Output can be customized, default is with a prompt and table.
